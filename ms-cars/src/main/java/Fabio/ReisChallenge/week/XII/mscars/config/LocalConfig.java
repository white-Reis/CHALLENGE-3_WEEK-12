...
public class LocalConfig {
   ...
   public LocalConfig(Aggregator aggregator) {
    ...
    public void startDB() {
        ...
        CarDTORequest f1 = new CarDTORequest("Mercedes", "AMG GT", p1, new Date(123,1,1));
        aggregator.createCar(f1);
        PilotDTORequest p2 = new PilotDTORequest("Sebastian Vettel", 34);
        CarDTORequest f2 = new CarDTORequest("Aston Martin", "Vantage", p2, new Date(123, 0, 0));
        aggregator.createCar(f2);
        PilotDTORequest p3 = new PilotDTORequest("Max Verstappen", 24);
        CarDTORequest f3 = new CarDTORequest("Red Bull Racing", "RB16B", p3, new Date(122, 0, 0));
        aggregator.createCar(f3);
        PilotDTORequest p4 = new PilotDTORequest("Charles Leclerc", 24);
        CarDTORequest f4 = new CarDTORequest("Ferrari", "SF21", p4, new Date(123, 0, 0));
        aggregator.createCar(f4);
        PilotDTORequest p5 = new PilotDTORequest("Valtteri Bottas", 32);
        CarDTORequest f5 = new CarDTORequest("Alfa Romeo", "C41", p5, new Date(123, 0, 0));
